...
public class DataGenerator implements CommandLineRunner {
     ...
     * User objects.
     */
    public UserAccount u1 = new UserAccount("josie_story@email.com", "123123123", "josieStory");
    public UserAccount u2 = new UserAccount("bernard@email.com", "123123123", "bernard");
    public UserAccount u3 = new UserAccount("faith.p@email.com", "123123123", "faith");
    public UserAccount u4 = new UserAccount("johnnie@email.com", "123123123", "johnnie");
    public UserAccount u5 = new UserAccount("lawrence.f@email.com", "123123123", "lawrence.f");
    /**
     * Cinema objects
     */
    ...
    AccountDetails a1 = new AccountDetails("Josie D Story", "262  Lochmere Lane", "United States", "Kentucky", "LOUISVILLE", 35, "40289", Role.USER);
    AccountDetails a2 = new AccountDetails("Bernard P Fendley", "2903  Jarvis Street", "United States", "New York", "Buffalo", 28, "14211", Role.USER);
    AccountDetails a3 = new AccountDetails("Faith R Parsons", "4161  Alfred Drive", "United States", "New York", "Brooklyn", 47, "11226", Role.USER);
    AccountDetails a4 = new AccountDetails("Johnnie J Cannon", "2587  Logan Lane", "United States", "New York", "HOLTSVILLE", 47, "00544", Role.USER);
    AccountDetails a5 = new AccountDetails("Lawrence E Folkerts", "698  Clark Street", "United States", "New York", "Brentwood", 47, "11717", Role.USER);
    ...
    private void createMoviesAndGenres() {
        ...
        m1.setGenres(Arrays.asList(g3, g1, g8));
        m2.setGenres(Arrays.asList(g13, g6));
        m3.setGenres(Arrays.asList(g6));
        m4.setGenres(Arrays.asList(g6, g8));
        m5.setGenres(Arrays.asList(g2, g3));
        m6.setGenres(Arrays.asList(g1));
        m7.setGenres(Arrays.asList(g4));
        m8.setGenres(Arrays.asList(g3, g8, g10));
        m9.setGenres(Arrays.asList(g3, g10));
