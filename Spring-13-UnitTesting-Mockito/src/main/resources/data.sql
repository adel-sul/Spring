...
insert into users(insert_date_time, insert_user_id, is_deleted, last_update_date_time, last_update_user_id, enabled, phone_number,
                    first_name, gender, last_name, user_name, role_id)
values ('2021-01-05 00:00:00', 1, false, '2021-01-05 00:00:00', 1, true, '(412) 636 3819',
                    'Tom', 'MALE', 'Hanks', 'admin@admin.com', 3);